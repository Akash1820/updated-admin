...
<div class="wrapper fadeInDown">
  ...
  <div id="form">
    ...
    <div id="formHeader">
      <h2 class="active" > Police Station Admin </h2>
      <h2 class="inactive underlineHover"><a href="webadmin" style="color: black; font-size-adjust: 15px;"><b>Web Adminstartion </b></a></h2>
    ...
    <div id="formFooter">
        <a class="underlineHover" href="RegReq">New Police Admin</a>
    </div>
  </div>
</div>
