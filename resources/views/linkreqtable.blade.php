...
<div class="tab" style="margin-top: 50px;">
  ...
  <form method="post" action="AdminFreg" style="margin-bottom: 0px;">
    {{ csrf_field() }}
...
<div id="LinkReq" class="tabcontent" style="width: 85%; margin-top: 50px;"">
      ...
      <div class="row">
        <div class="col-lg-12 mb-4">
          <div class="card card_border p-4">
            <h3 class="card__title position-absolute">Link Request Table</h3>
...
<br>
        ...
        <tr>
          ...
          <td>{{$row->User_ID}}</td>
          <td>{{$row->User_name}}</td>
          <td>{{$row->User_mailid}}</td>
          <td>{{$row->PS_name}}</td>
          
    <td>
<form method="post" action="linkapprove/{{$row->User_ID}}">  
{{ csrf_field() }}
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#anyid" onclick="form.submit()" >
  Accept
    ...
    <td>
 <form method="post" action="linkdenied/{{$row->User_ID}}"> 
  {{ csrf_field() }}
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#anyid"  onclick="form.submit()" >
  Decline
</button>
