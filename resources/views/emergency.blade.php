...
<div class="marquee">
    ...
    <form method="post" action="emrgncy" id="defaultOpen" style="margin-bottom: 0">
    {{ csrf_field() }}
  <button class="tablinks" onclick="form.submit()">Anonymous Complaints</button>
 </form>
  <form method="post" action="login" style="margin-bottom: 0">
    {{ csrf_field() }}
  <button class="tablinks" onclick="form.submit()">General Complaint</button>
  </form>
  <form method="post" action="srakshan" style="margin-bottom: 0">
    {{ csrf_field() }}
  <button class="tablinks" onclick="form.submit()">Sarvasya rakshan</button>
 </form> 
<form method="post" action="caware" style="margin-bottom: 0">
  {{ csrf_field() }}
  <button class="tablinks" onclick="form.submit()">Crime Awareness</button>
  </form>
  <form method="post" action="faq" style="margin-bottom: 0">
    {{ csrf_field() }}
  ...
  <!-- //header-ends -->
  <!-- main content start -->
  <div id="cmplnt" class="tabcontent" style="width: 85%; margin-top: 50px;"">
  ...
  <div class="container-fluid content-top-gap" style=" margin-top: 0%;">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Home / Anonymous Complaints</a></li>
      </ol>
    </nav>
      ...
      <div class="row">
        <div class="col-lg-12 mb-4">
          <div class="card card_border p-4">
            <h3 class="card__title position-absolute">All Complaint Info</h3>
...
<!-- Modal -->
<div class="modal fade" id="anyid" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
