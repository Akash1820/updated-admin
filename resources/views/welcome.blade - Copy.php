...
<div class="side">
<div class="sidenav" style="margin-left: 0;" >
...
<a href="login">Home</a>
  <a href="login_admin" style="float: right;">Adminstration Login</a>
...
<div class="marque">
    ...
    <form method="post" action="emrgncy" id="defaultOpen" style="margin-bottom: 0px;">
    {{ csrf_field() }}
  ...
  <div class="container-fluid content-top-gap" style=" margin-top: 0%;">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Home / General Complaint</a></li>
